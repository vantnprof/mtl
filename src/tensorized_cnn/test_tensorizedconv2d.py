# test_tensorizedconv2d.py

import unittest
import torch
from src.tensorized_cnn.tensorizedconv2d import TensorizedConv2d

class TestTensorizedConv2d(unittest.TestCase):
    def setUp(self):
        ...
        # Initialize the TensorizedConv2d layer
        self.tensorized_conv = TensorizedConv2d(
    ...
    def test_output_shape(self):
        # Forward pass
        output_tensor = self.tensorized_conv(self.input_tensor)
    ...
    def test_gradient_computation(self):
        ...
        for name, param in self.tensorized_conv.named_parameters():
